...
//! to approve or deny tool permissions without an active WebSocket connection.
//! The pending permission must have been surfaced via the WebSocket first —
//! the REST API resolves the same in-memory `PermissionMap`.
...
pub async fn resolve_permission(
    ...
    // Also clean up the metadata entry.
